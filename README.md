...
```
python val.py --model QCNet --root /home/alon/Learning/Argoverse2/ --ckpt_path /home/alon/Learning/QCNet/checkpoints/QCNet_AV2_Test.ckpt
```
python test.py --model QCNet --root /home/alon/Learning/Argoverse2/ --ckpt_path /home/alon/Learning/QCNet/checkpoints/QCNet_AV2_Test.ckpt
### Testing
